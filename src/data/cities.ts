...
export const CITIES: City[] = [
  { id: '01', name: 'Adana', lat: 37.0000, lng: 35.3213 },
  { id: '02', name: 'Adıyaman', lat: 37.7648, lng: 38.2786 },
  { id: '03', name: 'Afyonkarahisar', lat: 38.7507, lng: 30.5567 },
  { id: '04', name: 'Ağrı', lat: 39.7191, lng: 43.0503 },
  ...
  { id: '23', name: 'Elazığ', lat: 38.6810, lng: 39.2260 },
  ...
  { id: '35', name: 'İzmir', lat: 38.4189, lng: 27.1287 },
